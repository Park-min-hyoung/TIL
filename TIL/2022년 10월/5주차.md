...
function Cat(name, age) {
  // window 객체에 name과 age 값이 있음
  this.name = name;
  this.age = age;
}

// Cat 앞에 new 키워드 붙여주면 객체처럼 사용 가능
const tabby1 = Cat("nana", 7);
// undefined.name 하니까 오류 발생
...
var idiota = {
  ...
  members: {
    roto: {
      memberName: "roto",
      play: function () {
        // 여기서  this는 roto 객체를 가르킨다.
        // this.name => idiota.name으로 수정하면 문제 해결
        console.log(`band ${this.name} ${this.memberName} play`);
      },
    },
  },
};

idiota.members.roto.play();
```
